...
public class PmsProductCategoryController {
    ...
    public Object create(@Validated @RequestBody PmsProductCategoryParam productCategoryParam,
        ...
        //加上店铺id
        productCategoryParam.setUmsShopId(UmsAdminService.getCurrentUmsAdmin().getShopId());
...
//        List<PmsProductCategoryWithChildrenItem> list = productCategoryService.listWithChildren();
        ...
        List<PmsProductCategory> productCategoryList = productCategoryService.listLevel1();
