...
<script type="text/javascript">
    ...
    function connect() {
        // websocket的连接地址，此值等于WebSocketMessageBrokerConfigurer中registry.addEndpoint("/static.websocket-simple").withSockJS()配置的地址
        var socket = new SockJS('/static.websocket-rabbitmq'); //1
